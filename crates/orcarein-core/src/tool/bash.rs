...
impl Tool for BashTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> Result<ToolOutput, ToolError> {
        ...
        let stdout = crate::text::cap(&String::from_utf8_lossy(&output.stdout), MAX_STREAM_BYTES);
        let stderr = crate::text::cap(&String::from_utf8_lossy(&output.stderr), MAX_STREAM_BYTES);
